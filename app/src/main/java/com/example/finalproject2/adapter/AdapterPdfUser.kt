...
import com.example.finalproject2.filters.FilterPdfUser
import com.example.finalproject2.activities.PdfDetailsActivity
import com.example.finalproject2.app.MyApplication
import com.example.finalproject2.databinding.RowPdfUserBinding
...
class AdapterPdfUser : RecyclerView.Adapter<AdapterPdfUser.HolderPdfUser>, Filterable {
    ...
    public var pdfArrayList: ArrayList<ModelPdf> //public -> to access in filter class
    //arraylist to hold filtered pdfs
    public var filterList: ArrayList<ModelPdf>

    //viewBinding row_pdf_user.xml => RowPdfUserActivity
    ...
    override fun getItemCount(): Int {
        return pdfArrayList.size // return list size/ Num of records
    }
    ...
    override fun onBindViewHolder(holder: HolderPdfUser, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            //pass book id in intent, will used to get pdf info
