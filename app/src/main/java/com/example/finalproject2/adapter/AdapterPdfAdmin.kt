...
import com.example.finalproject2.filters.FilterAdminPdf
import com.example.finalproject2.activities.PdfDetailsActivity
import com.example.finalproject2.app.MyApplication
import com.example.finalproject2.activities.PdfEditActivity
import com.example.finalproject2.databinding.RowPdfAdminBinding
...
class AdapterPdfAdmin : RecyclerView.Adapter<AdapterPdfAdmin.HolderPdfAdmin>, Filterable {
    ...
    //filter object
    private var filter: FilterAdminPdf? = null
...
//        Get Data , Set Data , Handle click
        ...
        //handle click, show dialog 1- edit book / 2- Delete Book
        ...
        builder.setTitle("Choose Option")
            .setItems(options){dialog, position ->
                ...
                if (position == 0){
                    ...
                    intent.putExtra("bookId", bookId) // passed book id , well used to edit book
                    context.startActivity(intent)
                }
                else if (position==1){
                    //Delete item click
    ...
    override fun getFilter(): Filter {
        if (filter == null) {
            filter = FilterAdminPdf(filterList, this)
        }
        return filter as FilterAdminPdf
    }
